...
#### 下载安装:
``` bash
wget --no-check-certificate -O shadowsocks.sh https://github.com/tysonair/teddysun/shadowsocks_install/master/shadowsocks.sh
...
#### 下载安装:
``` bash
wget --no-check-certificate -O shadowsocks-go.sh https://github.com/tysonair/teddysun/shadowsocks_install/master/shadowsocks-go.sh
...
#### 下载安装:
``` bash
wget --no-check-certificate https://github.com/tysonair/teddysun/shadowsocks_install/master/shadowsocksR.sh
...
#### 下载安装:
``` bash
wget --no-check-certificate -O shadowsocks-all.sh https://github.com/tysonair/teddysun/shadowsocks_install/master/shadowsocks-all.sh
...
#### 下载安装:
``` bash
wget --no-check-certificate -O shadowsocks-libev-debian.sh https://github.com/tysonair/teddysun/shadowsocks_install/master/shadowsocks-libev-debian.sh
...
#### 下载安装:
``` bash
wget --no-check-certificate -O shadowsocks-libev.sh https://github.com/tysonair/teddysun/shadowsocks_install/master/shadowsocks-libev.sh
...
#### 下载安装:
``` bash
wget --no-check-certificate https://github.com/tysonair/teddysun/across/master/l2tp.sh
chmod +x l2tp.sh
./l2tp.sh
```
使用命令：
...
#### 下载安装:
``` bash
wget --no-check-certificate https://github.com/tysonair/teddysun/shadowsocks_install/master/haproxy.sh
chmod +x haproxy.sh
./haproxy.sh
```
卸载方法：
...
#### 下载安装:
``` bash
wget --no-check-certificate https://github.com/tysonair/teddysun/across/raw/master/kms.sh && chmod +x kms.sh && ./kms.sh
```
使用命令：
